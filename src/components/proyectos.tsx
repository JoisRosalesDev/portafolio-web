...
export function ThreeDCardDemo() {
  return (
    <>
      <main id="proyectos" className="grid lg:grid-cols-2 max-w-6xl mx-auto">
        <div>
          <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              >
                Paws At Route <span className="text-xs text-gray-300">2025 (En desarrollo)</span>
              </CardItem>
              <CardItem
                as="p"
                translateZ="60"
              ...
              >
                Aplicación web que conecta a dueños de mascotas con paseadores verificados.
              </CardItem>
              <CardItem translateZ="100" className="w-full mt-4">
                <img
                  src="/img/paws-cover.webp"
                  height="1000"
                  width="1000"
              ...
              <div className="flex justify-between items-center mt-20">
                <CardItem
                  translateZ={20}
                  as="a"
                  href="https://paws-at-route.vercel.app/"
                  target="__blank"
                ...
                <CardItem
                  translateZ={20}
                  as="a"
                  href="https://github.com/vMattS/PawsAtRoute"
                  target="__blank"
          ...
          <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              <CardItem
                ...
                className="text-xl font-bold text-neutral-600 dark:text-white"
              >
                YeezyVerse <span className="text-xs text-gray-300">2025 (Febrero)</span>
              </CardItem>
              <CardItem
                as="p"
                translateZ="60"
          ...
          <CardContainer className="inter-var">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              <CardItem
                ...
                className="text-xl font-bold text-neutral-600 dark:text-white"
              >
                My Condition <span className="text-xs text-gray-300">2025 (Enero)</span>
              </CardItem>
              <CardItem
                as="p"
                translateZ="60"
