    ...
    <div className="relative mx-auto my-10 flex max-w-7xl flex-col items-center justify-center">
      ...
      <div className="px-4 py-10 md:py-20">
        <h1 className="relative z-10 mx-auto max-w-4xl text-center text-2xl font-bold text-slate-700 md:text-4xl lg:text-7xl dark:text-slate-300">
          {"Desarrollador Frontend".split(" ").map((word, index) => (
            <motion.span
              key={index}
        ...
        <motion.p
          ...
          className="relative z-10 mx-auto max-w-xl py-4 text-pretty text-lg font-normal text-neutral-600 dark:text-neutral-400"
        >
          +3 años de experiencia en el desarrollo web y móvil, aún sin aplicar a
          un puesto laboral formal. Experiencia en proyectos personales y
          colaborativos.
        </motion.p>
        <motion.div
          initial={{
